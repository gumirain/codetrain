...
import jp.kelonos.dao.MeigenDao;
...
public class ListCategoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try (Connection conn = DataSourceManager.getConnection()) {
			...
			MeigenDao meigendao = new MeigenDao(conn);
			ArrayList<MeigenDto> meigenList = meigendao.selectAll();
			request.setAttribute("meigenList", meigenList);
			
			
			MeigenDao meigen = new MeigenDao(conn);
			int meigenCount = meigen.countmeigen();
			request.setAttribute("meigenCount", meigenCount);
