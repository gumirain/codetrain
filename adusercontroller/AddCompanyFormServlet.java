...
@WebServlet("/add-companyform")
public class AddCompanyFormServlet extends HttpServlet{
...
try (Connection conn = DataSourceManager.getConnection()) {
			...
			request.getRequestDispatcher("WEB-INF/add-company.jsp").forward(request, response);
