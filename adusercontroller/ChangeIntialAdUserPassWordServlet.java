...
@WebServlet("/change-intial-aduserpassword")
public class ChangeIntialAdUserPassWordServlet extends HttpServlet{
...
//				AdUserDao changePasswordDao = new AdUserDao(conn);
//				changePasswordDao.updatePassword(Email, newPassword);
//				request.getRequestDispatcher("list-aduser.jsp").forward(request, response);
//			}
//		} catch (SQLException | NamingException e) {
//
//               // システムエラーに遷移する
