...
@WebServlet("/delete-article-send")
public class DeleteArticleSendServlet extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try (Connection conn = DataSourceManager.getConnection()) {
			...
			req.getRequestDispatcher("WEB-INF/delete-article.jsp").forward(req, resp);
